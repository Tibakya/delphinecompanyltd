        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-xl-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Address</h4>
                                            <p class="mb-0">Plot 123, Dar es Salaam, Tanzania</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Email</h4>
                                            <p class="mb-0">info@delphinecompany.com</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Phone</h4>
                                            <p class="mb-0">+255 757 473 177</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Website</h4>
                                            <p class="mb-0">www.delphinecompanyltd.co.tz</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-light p-5 rounded h-100 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <p class="mb-4">Feel free to reach out to us for any inquiries or collaborations. We look forward to hearing from you!</p>
                            <form>
                                <div class="row g-4">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.869710850085!2d39.11302477392326!3d-6.785705666359792!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x185c4572d81cc129%3A0xf2549090f44e17bd!2sMbezi!5e0!3m2!1sen!2stz!4v1736268176253!5m2!1sen!2stz" width="600" height="1200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
                </div>
            </div>
        </div>
    </div>
