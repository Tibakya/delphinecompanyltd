            ...
            <div class="row g-5 align-items-center">
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                    <div>
                        ...
                        <h1 class="display-5 mb-4">Meet our company, your trusted partner</h1>
                        <p class="mb-4">Delphine Company Ltd is a leading provider of software development and innovative technology solutions. Our mission is to optimize businesses, build infrastructure, and strengthen communities. We offer tailored solutions that help businesses achieve success with sustainable, cost-effective practices.</p>
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p>We help businesses streamline operations, improve productivity, and drive success.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p>With years of experience in the field, we offer expert guidance and innovative solutions.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <a href="#" class="btn btn-primary rounded-pill py-3 px-5 flex-shrink-0">Discover More</a>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h4>Call Us</h4>
                                        <p class="mb-0 fs-5" style="letter-spacing: 1px;">+255 757 473 177</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded position-relative overflow-hidden">
                        <img src="img/about22.png" class="img-fluid rounded w-100" alt="">
...
<div class="container-fluid feature pb-5">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            ...
            <p class="mb-0">At Delphine Company Ltd, we offer innovative solutions that drive success in the construction industry. Our services range from quality construction materials to expert consulting, ensuring every project achieves its fullest potential.</p>
        </div>
        <div class="row g-4">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item p-4">
                    ...
                    <p class="mb-4">We partner with international manufacturers to source the best materials for your construction needs, ensuring quality, durability, and cost-effectiveness.</p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="feature-item p-4">
                    ...
                    <p class="mb-4">Our team provides expert consulting services that guide you through every phase of your construction project, ensuring the best practices are followed for success.</p>
                    <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-item p-4">
                    ...
                    <p class="mb-4">We provide seamless logistics and supply chain management, ensuring that the materials reach your site on time and within budget.</p>
                    <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="feature-item p-4">
                    ...
                    <p class="mb-4">We work with you to offer cost-effective solutions without compromising on quality, making your project both successful and affordable.</p>
                    <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                </div>
            </div>
        </div>
